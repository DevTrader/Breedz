...
class App extends Component {
  ...
  openUserMenu = () => {
    document.body.style.overflowY = "hidden";
    document.getElementsByClassName('ProfileInfo')[0].setAttribute("id", "opacityGlobal");
    document.getElementsByClassName('ProfileInfo')[0].style.display = 'block';
  }

  closeUserMenu = () => {
    document.body.style.overflowY = "scroll";
    
    document.getElementsByClassName('ProfileInfo')[0].removeAttribute("id", "opacityGlobal");
    document.getElementsByClassName('ProfileInfo')[0].setAttribute("id", "opacityGlobalClose");
    setTimeout( function(){
      document.getElementsByClassName('ProfileInfo')[0].style.display = 'none';
    }, 1700)
  }
  ...
  render() {
    ...
    return (
      ...
      {/* profile info */}
        <LandingPage />
        <NavHeader openFave = {this.openFaveMenu} openUser = {this.openUserMenu}/>
        <HeartOverlay />
        ...
        <ProfileInfo userName = {this.state.username} closeUserInfo = {this.closeUserMenu}/>
